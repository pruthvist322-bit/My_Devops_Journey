...
During Day 35 to Day 40 of my DevOps learning journey, I learned about **Jenkins** and how it can be used to automate the Continuous Integration and Continuous Deployment (CI/CD) process.
